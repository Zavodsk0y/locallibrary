...
class Genre(models.Model):
    name = models.CharField(max_length=200, help_text='Введите жанр книги (напр. фантастика)')
...
class Book(models.Model):
    ...
    isbn = models.CharField('ISBN', max_length=13, unique=True,
                            help_text='13 знаков <a href="https://www.isbn-international.org/content/what-isbn">ISBN number</a>')
